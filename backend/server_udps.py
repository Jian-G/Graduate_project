...
if __name__ == '__main__':
    ...
    t_send1 = threading.Thread(target=send_file, args=(udp_socket, ('',8000),))
    # t_send2 = threading.Thread(target=send_file, args=(udp_socket, ('',8102),))
    # t_send3 = threading.Thread(target=send_file, args=(udp_socket, ('',8103),))
