from FountainCode.core import *
from FountainCode.distributions import *
import json
import sys
...
def encode(blocks, drops_quantity, filename):
    ...
    for i in range(drops_quantity):
        ...
        packet = Packet(packet_type= 0, index=i, degree=deg, data=drop)
